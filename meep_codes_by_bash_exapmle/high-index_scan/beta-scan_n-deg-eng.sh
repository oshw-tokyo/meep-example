...
res=30 #10 # shold be more greater than 15 when n=1.46, or 30 when n=3.4
for ind in "340" #"146"    "145"
do
mkdir OI-DLA_n${ind}/
echo "directroy:OI-DLA_n${ind}/ ...made " 
for dep in "2" # "4" # 100 for test of no grating (#: S式コメントアウト in scheme が便利)
do
...
for fld in ex ey hz
do
for dy in 0 -6 # -11 -16 -21 -26 -31 # h=1.086956522 in meep when n=1.46 and lm=1.0, h/2=5.43, resl=10
do
...
cd ../
cd ../../../../../
echo "dep:${dep}, n:${ind}, eng${eng}, th:${th}" >> beta-scan_hist.txt
