...
res=25 #30 #10 # shold be more greater than 15 when n=1.46, 30 when n=3.4, 20 when n=2.42
for ind in  242 # "340" #"146"    "145"
do
mkdir OI-DLA_n${ind}/
...
for fld in ex ey hz
do
for dy in 0 5 10 20 30 50 100 # -11 -16 -21 -26 -31 # h=1.086956522 in meep when n=1.46 and lm=1.0, h/2=5.43, resl=10
do
